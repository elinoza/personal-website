            ...
            >
              ...
              <div className="infos">
                ...
                <div className="header ">
                  ...
                  {detail.Description}
                  <hr />
                  <p>The tools used in the project:</p>{" "}
                  {detail.Tools.map((elem) => find_logo(elem))}{" "}
                </div>
              </div>
              <div className="information">
                <div className="links">
                 ...
                 href={detail.WebUrl} target="_blank"
                  >
